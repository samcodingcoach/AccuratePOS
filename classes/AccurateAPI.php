...
class AccurateAPI {
    ...
    public function getStockOpnameOrderList($params = array(), $page = 1, $limit = 100) {
        ...
        $defaultParams = array(
            'sp.pageSize' => $limit,
            'sp.page' => $page,
            'fields' => 'id,number,startDate,description,transDate,branchName,personCharged,warehouse,warehouse.name,statusName'
        );
    ...
    public function getStockOpnameResultList($params = array(), $page = 1, $limit = 100) {
        $endpoint = 'accurate/api/stock-opname-result/list.do';
        
        $defaultParams = array(
            'sp.pageSize' => $limit,
            'sp.page' => $page,
            'fields' => 'id,number,description,transDate,order'
        );
    ...
    public function getStockOpnameResultDetail($id = null, $number = null) {
        $endpoint = 'accurate/api/stock-opname-result/detail.do';
        $params = array();
