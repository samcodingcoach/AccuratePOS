<?php
/**
 * API PROMO CANCEL KUOTA
 * File: api/promo/cancel-kuota.php
...
try {
    ...
    // 5. Query UPDATE (Menambahkan kuota kembali)
    ...
    if ($stmt->affected_rows > 0) {
        ...
        // Bisa berarti data tidak ditemukan atau nilai penambahan adalah 0
        $message = 'Tidak ada data yang diupdate (mungkin data tidak ditemukan)';
    } else {
        throw new Exception("Gagal mengembalikan kuota promo: " . $stmt->error);
    }
