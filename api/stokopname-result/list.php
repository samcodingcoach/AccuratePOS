<?php
/**
 * API STOK OPNAME RESULT - LIST
 * File: api/stokopname-result/list.php
 */
...
try {
    $api = new AccurateAPI();
    $result = $api->getStockOpnameResultList($params, $page, $limit);
    ...
    if (isset($result['success']) && $result['success']) {
        ...
        echo json_encode([
            'status'  => 'error',
            'message' => $result['message'] ?? 'Gagal mengambil data stok opname result',
