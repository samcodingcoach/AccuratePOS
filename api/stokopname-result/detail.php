<?php
/**
 * API STOK OPNAME RESULT - DETAIL
 * File: api/stokopname-result/detail.php
 */
...
try {
    $api = new AccurateAPI();
    $result = $api->getStockOpnameResultDetail($id, $number);
    ...
    if (isset($result['success']) && $result['success']) {
        ...
        echo json_encode([
            'status'  => 'error',
            'message' => $result['message'] ?? 'Gagal mengambil detail stok opname result',
